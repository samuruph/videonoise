...
Produces 4–5 PNG panels per dataset in results/<key>/plots/:
  ...
  05_noise_stats.png         — inverted-noise stats (when noise_stats.json exists)

Step-specific flag:
    --mode  real | gen | both   (default: both)

All other settings come from scripts/config.yaml. Override any from CLI:
    python -m videonoise.scripts.viz_metrics --mode real
"""
